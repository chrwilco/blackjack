...
public class Card2 implements Serializable {
	...
	public Card2(char newSuit, int newValue) throws InvalidCardValueException, InvalidCardSuitException {
	...
	public boolean compareSuit(Card2 card){
		
		return this.suit == card.getSuitDesignator();
		
	}
	
	public boolean compareValue(Card2 card){
		
		return this.value == card.getValue();
	}
	
	public boolean compareTo(Card2 card){
